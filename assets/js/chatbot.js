...
(function () {
  ...
  var INTENTS = [
    ...
    { keys: ['book', 'appointment', 'booking', 'make an appointment', 'see tony', 'arrange', 'schedule'],
      reply: { text: 'There is no complicated booking system. Send a short enquiry and Tony will come back to you personally, usually within one working day, to arrange a time. If it is urgent, call him.',
              acts: ['book', 'call'] } },
